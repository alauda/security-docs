...
- **Central Services**: Deployed on a single cluster, providing management, API, and UI (ACS Portal). Includes Central, Central DB (PostgreSQL 13), and the Scanner V4 vulnerability scanner.
