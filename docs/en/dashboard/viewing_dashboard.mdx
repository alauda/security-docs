...
The Alauda Container Security for Kubernetes Dashboard provides a centralized view of your cluster's security and compliance posture. This document introduces the Dashboard's main components and explains how to use its features to monitor and manage your environment effectively.
