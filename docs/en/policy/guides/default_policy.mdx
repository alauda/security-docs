---
title: Default Policies in Alauda Security Service
description: Overview of default and custom policies in Alauda Security Service.
weight: 30
---
...
| Runtime | Unauthorized Process Execution | Alerts on unauthorized process execution in locked baselines. | Enabled |
