...
> **Note:** Scanning the entire environment typically takes about 2 minutes, depending on the number of clusters and nodes.
...
Alauda Container Security supports NIST, PCI DSS, HIPAA, and CIS for Kubernetes compliance standards. To view controls for a specific standard:
...
> **Tip:** The **Export** option is available on all compliance pages and filtered views.
...
|------------------------------------------------|----------------------------------|
| CIS Benchmark for Kubernetes                   | CIS Kubernetes v1.5.0            |
| HIPAA (Health Insurance Portability and Accountability Act) | HIPAA 164                    |
| NIST (National Institute of Standards and Technology)        | NIST SP 800-190, 800-53 Rev.4 |
