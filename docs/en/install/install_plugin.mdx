...
| central.exposure.ingress.enabled                       | Use true to expose Central by using an ingress. Disables all ingress settings if set to false. This parameter is only available for Alauda Container Platform clusters. |
