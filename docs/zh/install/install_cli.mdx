---
weight: 10
sourceSHA: f3d2638f0302b55d65b9bb4ba50436abae24c56ac73c798d1e8f000c2fac8eba
---

# Roxctl CLI 安装

本指南提供了安装、配置和使用 Alauda 容器安全的 `roxctl` 命令行界面 (CLI) 的说明。该 CLI 可用于 Linux、macOS、Windows，并作为容器镜像提供。
